...
export default function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  /* Reset the content scroller on route change (body no longer scrolls) */
  useEffect(() => {
  ...
  return (
    <div className="font-admin-scope flex h-dvh overflow-hidden bg-background">
      <Toaster />
      ...
      {/* ─── Main column (own scroll container; body never scrolls) ─── */}
