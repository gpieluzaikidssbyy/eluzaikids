                ...
                {churchInfo?.address && (
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-2 leading-7 text-slate-600 dark:text-slate-400">{churchInfo.address}</p>
                    </div>
                  </div>
                )}
                {churchInfo?.email && (
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-display text-lg font-bold text-slate-900 dark:text-slate-100">Email</h3>
                      <p className="mt-2 leading-7 text-slate-600 dark:text-slate-400">{churchInfo.email}</p>
                    </div>
                  </div>
                )}
