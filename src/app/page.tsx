          ...
          {data.churchInfo && (
            <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                >
                  <div
                    className="flex h-16 w-16 items-center justify-center rounded-full border border-slate-200 bg-transparent shadow-sm dark:border-slate-600"
                    style={{ color: contact.brand }}
                  >
                    {contact.icon}
                  </div>
